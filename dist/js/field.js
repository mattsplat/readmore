...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-readmore', __webpack_require__(3));
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "p",
      { class: { "pt-3 pb-3": _vm.showAll }, on: { click: _vm.toggle } },
      [
        _vm._v("\n        " + _vm._s(_vm.message) + "\n        "),
        !_vm.showAll
          ? _c("span", { staticClass: "read-more-mask" }, [
              _c("span", { domProps: { innerHTML: _vm._s(_vm.mask) } })
            ])
          : _vm._e()
      ]
    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-923b3414", module.exports)
  }
}
